...
-- disabled most defaults. one of these is causing lag with {, }, and telescope
tmux.setup {
  copy_sync = {
...
lvim.keys.normal_mode["<M-h>"] = '<cmd>lua require("tmux").resize_left()<cr>'
lvim.keys.normal_mode["<M-j>"] = '<cmd>lua require("tmux").resize_bottom()<cr>'
lvim.keys.normal_mode["<M-k>"] = '<cmd>lua require("tmux").resize_top()<cr>'
lvim.keys.normal_mode["<M-l>"] = '<cmd>lua require("tmux").resize_right()<cr>'
